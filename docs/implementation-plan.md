...
- [x] Static horse models placed in pastures — CC0 rigged/animated horse model (Quaternius, see [decisions.md](project/decisions.md) D-9), now 2 instances roaming a shared rectangular pasture area near Turn Out Shed 1 rather than circling a fixed home point (D-27)
